        ...
        >
          ...
          <div className="md:w-1/2 p-6 md:p-8">
            ...
            >
              <div className="flex text-yellow-400">
                {[...Array(5)].map((_, i) => (
                  <svg
                    key={i}
                    className={`w-5 h-5 ${i < Math.floor(data.Rating) ? 'fill-current' : 'stroke-current'}`}
                    viewBox="0 0 24 24"
                  >
                    <path
              ...
              <span className="ml-2 text-gray-600">{data.Rating} • {data.Reviews.length} reviews</span>
            </motion.div>
            ...
            >
              ...
              <span className="ml-3 text-lg text-gray-500 line-through">${data.Price}</span>
            </motion.div>
                ...
                {data.Colors.map((color, index) => (
                  <motion.button
                    ...
                    className={`w-8 h-8 rounded-full border-2 ${
                      selectedColor === index ? 'border-blue-500' : 'border-gray-200'
                    }`}
            ...
            >
              ...
              <span className="ml-4 text-sm text-gray-500">{data.Stock} available</span>
            </motion.div>
